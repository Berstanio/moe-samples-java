...
public class ScatterChartView extends BarLineChartViewBase implements ScatterChartDataProvider {
    ...
    public static native ScatterChartView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public ScatterChartView _appearanceWhenContainedIn(@Mapped(ObjCObjectMapper.class) UIAppearanceContainer ContainerClass,
            Object... varargs) {
    ...
    public native ScatterChartView initWithFrame(@ByValue apple.coregraphics.struct.CGRect frame);
