...
@ObjCProtocolSourceName("LineChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts24LineChartDataSetProtocol_")
public interface LineChartDataSetProtocol extends LineRadarChartDataSetProtocol {
    @Generated
    ...
    ChartFillFormatter fillFormatter();
    ...
    NSArray<? extends NSNumber> gradientPositions();
    ...
    void setFillFormatter(@Mapped(ObjCObjectMapper.class) ChartFillFormatter value);
    ...
    void setGradientPositions(NSArray<? extends NSNumber> value);
    ...
    void setIsDrawLineWithGradientEnabled(boolean value);
