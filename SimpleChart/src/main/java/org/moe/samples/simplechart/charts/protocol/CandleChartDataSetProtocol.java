...
@ObjCProtocolSourceName("CandleChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts26CandleChartDataSetProtocol_")
public interface CandleChartDataSetProtocol extends LineScatterCandleRadarChartDataSetProtocol {
    /**
