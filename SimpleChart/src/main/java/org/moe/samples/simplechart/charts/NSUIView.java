...
public class NSUIView extends UIView {
    ...
    public static native NSUIView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(UITraitCollection trait,
    ...
    public native NSUIView initWithFrame(@ByValue apple.coregraphics.struct.CGRect frame);
