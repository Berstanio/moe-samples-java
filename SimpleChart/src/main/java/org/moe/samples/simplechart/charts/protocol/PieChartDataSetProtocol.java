...
@ObjCProtocolSourceName("PieChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts23PieChartDataSetProtocol_")
public interface PieChartDataSetProtocol extends ChartDataSetProtocol {
    /**
