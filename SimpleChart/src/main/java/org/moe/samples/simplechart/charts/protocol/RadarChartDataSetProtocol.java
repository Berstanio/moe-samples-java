...
@ObjCProtocolSourceName("RadarChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts25RadarChartDataSetProtocol_")
public interface RadarChartDataSetProtocol extends LineRadarChartDataSetProtocol {
    /**
