...
@ObjCProtocolSourceName("ChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts20ChartDataSetProtocol_")
public interface ChartDataSetProtocol {
    @Generated
    @Selector("addColor:")
    ...
    void setValueFormatter(@Mapped(ObjCObjectMapper.class) ChartValueFormatter value);
    ...
    void setValueLabelAngle(double value);
