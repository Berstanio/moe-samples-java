...
@ObjCProtocolSourceName("BarChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts23BarChartDataSetProtocol_")
public interface BarChartDataSetProtocol extends BarLineScatterCandleBubbleChartDataSetProtocol {
    /**
