...
@ObjCProtocolSourceName("LineRadarChartDataSetProtocol")
@ObjCProtocolName("_TtP6Charts29LineRadarChartDataSetProtocol_")
public interface LineRadarChartDataSetProtocol extends LineScatterCandleRadarChartDataSetProtocol {
    /**
    ...
    @Generated
    @Selector("setFill:")
    void setFill(@Mapped(ObjCObjectMapper.class) ChartFill value);
